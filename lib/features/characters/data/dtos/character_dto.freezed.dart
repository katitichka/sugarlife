...
mixin _$CharacterDto {
 ...
 int get id;@JsonKey(name: 'image_url') String get imageUrl; String get name;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CharacterDto&&(identical(other.id, id) || other.id == id)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'CharacterDto(id: $id, imageUrl: $imageUrl, name: $name)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'image_url') String imageUrl, String name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'image_url')  String imageUrl,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CharacterDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'image_url')  String imageUrl,  String name)  $default,) {final _that = this;
switch (_that) {
case _CharacterDto():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'image_url')  String imageUrl,  String name)?  $default,) {final _that = this;
switch (_that) {
case _CharacterDto() when $default != null:
return $default(_that.id,_that.imageUrl,_that.name);case _:
  return null;
...
class _CharacterDto implements CharacterDto {
  const _CharacterDto({required this.id, @JsonKey(name: 'image_url') required this.imageUrl, required this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CharacterDto&&(identical(other.id, id) || other.id == id)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.name, name) || other.name == name));
}
