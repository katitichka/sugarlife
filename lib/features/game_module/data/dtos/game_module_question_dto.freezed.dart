...
mixin _$GameModuleQuestionDto {
  ...
  $GameModuleQuestionDtoCopyWith<GameModuleQuestionDto> get copyWith =>
      _$GameModuleQuestionDtoCopyWithImpl<GameModuleQuestionDto>(
          this as GameModuleQuestionDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GameModuleQuestionDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.question, question) ||
                other.question == question) &&
            (identical(other.questionsType, questionsType) ||
                other.questionsType == questionsType) &&
...
abstract mixin class $GameModuleQuestionDtoCopyWith<$Res> {
  factory $GameModuleQuestionDtoCopyWith(GameModuleQuestionDto value,
          $Res Function(GameModuleQuestionDto) _then) =
      _$GameModuleQuestionDtoCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      String question,
      @JsonKey(name: 'question_type') String questionsType,
      List<String> answers,
      String explanation,
    ...
    return _then(_self.copyWith(
      ...
      question: null == question
          ...
          : question // ignore: cast_nullable_to_non_nullable
              as String,
      questionsType: null == questionsType
          ? _self.questionsType
          : questionsType // ignore: cast_nullable_to_non_nullable
              as String,
...
extension GameModuleQuestionDtoPatterns on GameModuleQuestionDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GameModuleQuestionDto value)? $default, {
...
class _GameModuleQuestionDto implements GameModuleQuestionDto {
  const _GameModuleQuestionDto(
      {required this.id,
      required this.question,
      @JsonKey(name: 'question_type') required this.questionsType,
      required final List<String> answers,
      required this.explanation,
      @JsonKey(name: 'order_index') required this.orderIndex,
      @JsonKey(name: 'level_id') required this.levelId,
      @JsonKey(name: 'age_category') required this.ageCategory,
      @JsonKey(name: 'correct_answer') required this.correctAnswer})
      : _answers = answers;
  factory _GameModuleQuestionDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GameModuleQuestionDtoCopyWith<_GameModuleQuestionDto> get copyWith =>
      __$GameModuleQuestionDtoCopyWithImpl<_GameModuleQuestionDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GameModuleQuestionDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GameModuleQuestionDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.question, question) ||
                other.question == question) &&
            (identical(other.questionsType, questionsType) ||
...
/// @nodoc
abstract mixin class _$GameModuleQuestionDtoCopyWith<$Res>
    implements $GameModuleQuestionDtoCopyWith<$Res> {
  factory _$GameModuleQuestionDtoCopyWith(_GameModuleQuestionDto value,
          $Res Function(_GameModuleQuestionDto) _then) =
      __$GameModuleQuestionDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
