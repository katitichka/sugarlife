...
sealed class GameModuleLevelEvent with _$GameModuleLevelEvent {
  ...
  const factory GameModuleLevelEvent.answerMultipleChoice({
    required String answer,
  }) = _AnswerMultipleChoice;
  const factory GameModuleLevelEvent.answerTrueFalse({required bool answer}) =
      _AnswerTrueFalse;
  const factory GameModuleLevelEvent.answerFillBlank({required String answer}) =
      _AnswerFillBlank;
