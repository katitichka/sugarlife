...
sealed class GameModuleListBloc
  ...
  Future<void> _onReceiveGameModuleList(
    ...
    try {
      final gameModuleList = await _gameModuleListRepository
          .getLevelsForSnake();
      emit(GameModuleListState.receiveSuccess(gameModules: gameModuleList));
    } catch (e) {
      emit(
        GameModuleListState.receiveFailed(
          message: 'Ошибка загрузки игрового модуля',
        ),
      );
    }
  }
