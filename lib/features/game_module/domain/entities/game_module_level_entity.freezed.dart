...
mixin _$GameModuleLevelEntity {
  ...
  $GameModuleLevelEntityCopyWith<GameModuleLevelEntity> get copyWith =>
      _$GameModuleLevelEntityCopyWithImpl<GameModuleLevelEntity>(
          this as GameModuleLevelEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GameModuleLevelEntity &&
  ...
  @override
  String toString() {
    return 'GameModuleLevelEntity(id: $id, title: $title, orderIndex: $orderIndex)';
  }
}

/// @nodoc
abstract mixin class $GameModuleLevelEntityCopyWith<$Res> {
  factory $GameModuleLevelEntityCopyWith(GameModuleLevelEntity value,
          $Res Function(GameModuleLevelEntity) _then) =
      _$GameModuleLevelEntityCopyWithImpl;
  @useResult
  $Res call({int id, String title, int orderIndex});
}
...
extension GameModuleLevelEntityPatterns on GameModuleLevelEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GameModuleLevelEntity value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String title, int orderIndex)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _GameModuleLevelEntity implements GameModuleLevelEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GameModuleLevelEntityCopyWith<_GameModuleLevelEntity> get copyWith =>
      __$GameModuleLevelEntityCopyWithImpl<_GameModuleLevelEntity>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GameModuleLevelEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.orderIndex, orderIndex) ||
                other.orderIndex == orderIndex));
...
/// @nodoc
abstract mixin class _$GameModuleLevelEntityCopyWith<$Res>
    implements $GameModuleLevelEntityCopyWith<$Res> {
  factory _$GameModuleLevelEntityCopyWith(_GameModuleLevelEntity value,
          $Res Function(_GameModuleLevelEntity) _then) =
      __$GameModuleLevelEntityCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String title, int orderIndex});
}
