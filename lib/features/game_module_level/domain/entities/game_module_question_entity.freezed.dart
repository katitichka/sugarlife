...
mixin _$GameModuleQuestionEntity {
 ...
 int get id; String get question; QuestionType get questionType; List<String> get answers; String get explanation; int get orderIndex; int get levelId; AgeCategory get ageCategory; String get correctAnswer;
...
@override
int get hashCode => Object.hash(runtimeType,id,question,questionType,const DeepCollectionEquality().hash(answers),explanation,orderIndex,levelId,ageCategory,correctAnswer);

@override
String toString() {
  return 'GameModuleQuestionEntity(id: $id, question: $question, questionType: $questionType, answers: $answers, explanation: $explanation, orderIndex: $orderIndex, levelId: $levelId, ageCategory: $ageCategory, correctAnswer: $correctAnswer)';
}
...
@useResult
$Res call({
 int id, String question, QuestionType questionType, List<String> answers, String explanation, int orderIndex, int levelId, AgeCategory ageCategory, String correctAnswer
});
...
/// Create a copy of GameModuleQuestionEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? question = null,Object? questionType = null,Object? answers = null,Object? explanation = null,Object? orderIndex = null,Object? levelId = null,Object? ageCategory = null,Object? correctAnswer = null,}) {
...
as AgeCategory,correctAnswer: null == correctAnswer ? _self.correctAnswer : correctAnswer // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String question,  QuestionType questionType,  List<String> answers,  String explanation,  int orderIndex,  int levelId,  AgeCategory ageCategory,  String correctAnswer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameModuleQuestionEntity() when $default != null:
return $default(_that.id,_that.question,_that.questionType,_that.answers,_that.explanation,_that.orderIndex,_that.levelId,_that.ageCategory,_that.correctAnswer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String question,  QuestionType questionType,  List<String> answers,  String explanation,  int orderIndex,  int levelId,  AgeCategory ageCategory,  String correctAnswer)  $default,) {final _that = this;
switch (_that) {
case _GameModuleQuestionEntity():
return $default(_that.id,_that.question,_that.questionType,_that.answers,_that.explanation,_that.orderIndex,_that.levelId,_that.ageCategory,_that.correctAnswer);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String question,  QuestionType questionType,  List<String> answers,  String explanation,  int orderIndex,  int levelId,  AgeCategory ageCategory,  String correctAnswer)?  $default,) {final _that = this;
switch (_that) {
case _GameModuleQuestionEntity() when $default != null:
return $default(_that.id,_that.question,_that.questionType,_that.answers,_that.explanation,_that.orderIndex,_that.levelId,_that.ageCategory,_that.correctAnswer);case _:
  return null;
...
class _GameModuleQuestionEntity extends GameModuleQuestionEntity {
  const _GameModuleQuestionEntity({required this.id, required this.question, required this.questionType, required final  List<String> answers, required this.explanation, required this.orderIndex, required this.levelId, required this.ageCategory, required this.correctAnswer}): _answers = answers,super._();
...
@override
int get hashCode => Object.hash(runtimeType,id,question,questionType,const DeepCollectionEquality().hash(_answers),explanation,orderIndex,levelId,ageCategory,correctAnswer);
...
/// Create a copy of GameModuleQuestionEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? question = null,Object? questionType = null,Object? answers = null,Object? explanation = null,Object? orderIndex = null,Object? levelId = null,Object? ageCategory = null,Object? correctAnswer = null,}) {
