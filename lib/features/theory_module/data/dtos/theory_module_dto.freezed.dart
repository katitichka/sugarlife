...
mixin _$TheoryModuleDto {
  ...
  int get orderIndex;
  @JsonKey(name: 'character_image_url')
  ...
  $TheoryModuleDtoCopyWith<TheoryModuleDto> get copyWith =>
      _$TheoryModuleDtoCopyWithImpl<TheoryModuleDto>(
          this as TheoryModuleDto, _$identity);
...
abstract mixin class $TheoryModuleDtoCopyWith<$Res> {
  factory $TheoryModuleDtoCopyWith(
          TheoryModuleDto value, $Res Function(TheoryModuleDto) _then) =
      _$TheoryModuleDtoCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      String title,
...
extension TheoryModuleDtoPatterns on TheoryModuleDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TheoryModuleDto value)? $default, {
...
class _TheoryModuleDto implements TheoryModuleDto {
  const _TheoryModuleDto(
      ...
      @JsonKey(name: 'character_image_url') required this.characterImageUrl,
      required final Map<String, dynamic> content})
      : _content = content;
  factory _TheoryModuleDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TheoryModuleDtoCopyWith<_TheoryModuleDto> get copyWith =>
      __$TheoryModuleDtoCopyWithImpl<_TheoryModuleDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TheoryModuleDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$TheoryModuleDtoCopyWith<$Res>
    implements $TheoryModuleDtoCopyWith<$Res> {
  factory _$TheoryModuleDtoCopyWith(
          _TheoryModuleDto value, $Res Function(_TheoryModuleDto) _then) =
      __$TheoryModuleDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
