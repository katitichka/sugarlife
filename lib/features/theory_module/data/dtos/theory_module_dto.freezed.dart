...
mixin _$TheoryModuleDto {
 ...
 int get id; String get title; String get subtitle;@JsonKey(name: 'character_id') int get characterId;@JsonKey(name: 'color_hex') String get colorHex;@JsonKey(name: 'order_index') int get orderIndex;@JsonKey(name: 'character_image_url') String get characterImageUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,subtitle,characterId,colorHex,orderIndex,characterImageUrl);

@override
String toString() {
  return 'TheoryModuleDto(id: $id, title: $title, subtitle: $subtitle, characterId: $characterId, colorHex: $colorHex, orderIndex: $orderIndex, characterImageUrl: $characterImageUrl)';
}
...
@useResult
$Res call({
 int id, String title, String subtitle,@JsonKey(name: 'character_id') int characterId,@JsonKey(name: 'color_hex') String colorHex,@JsonKey(name: 'order_index') int orderIndex,@JsonKey(name: 'character_image_url') String characterImageUrl
});
...
/// Create a copy of TheoryModuleDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? characterId = null,Object? colorHex = null,Object? orderIndex = null,Object? characterImageUrl = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String subtitle, @JsonKey(name: 'character_id')  int characterId, @JsonKey(name: 'color_hex')  String colorHex, @JsonKey(name: 'order_index')  int orderIndex, @JsonKey(name: 'character_image_url')  String characterImageUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TheoryModuleDto() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.characterId,_that.colorHex,_that.orderIndex,_that.characterImageUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String subtitle, @JsonKey(name: 'character_id')  int characterId, @JsonKey(name: 'color_hex')  String colorHex, @JsonKey(name: 'order_index')  int orderIndex, @JsonKey(name: 'character_image_url')  String characterImageUrl)  $default,) {final _that = this;
switch (_that) {
case _TheoryModuleDto():
return $default(_that.id,_that.title,_that.subtitle,_that.characterId,_that.colorHex,_that.orderIndex,_that.characterImageUrl);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String subtitle, @JsonKey(name: 'character_id')  int characterId, @JsonKey(name: 'color_hex')  String colorHex, @JsonKey(name: 'order_index')  int orderIndex, @JsonKey(name: 'character_image_url')  String characterImageUrl)?  $default,) {final _that = this;
switch (_that) {
case _TheoryModuleDto() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.characterId,_that.colorHex,_that.orderIndex,_that.characterImageUrl);case _:
  return null;
...
class _TheoryModuleDto implements TheoryModuleDto {
  const _TheoryModuleDto({required this.id, required this.title, required this.subtitle, @JsonKey(name: 'character_id') required this.characterId, @JsonKey(name: 'color_hex') required this.colorHex, @JsonKey(name: 'order_index') required this.orderIndex, @JsonKey(name: 'character_image_url') required this.characterImageUrl});
...
/// Create a copy of TheoryModuleDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? subtitle = null,Object? characterId = null,Object? colorHex = null,Object? orderIndex = null,Object? characterImageUrl = null,}) {
