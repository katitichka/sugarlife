...
mixin _$ProfileDocsResponseDto {
  ...
  $ProfileDocsResponseDtoCopyWith<ProfileDocsResponseDto> get copyWith =>
      _$ProfileDocsResponseDtoCopyWithImpl<ProfileDocsResponseDto>(
          this as ProfileDocsResponseDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProfileDocsResponseDto &&
...
abstract mixin class $ProfileDocsResponseDtoCopyWith<$Res> {
  factory $ProfileDocsResponseDtoCopyWith(ProfileDocsResponseDto value,
          $Res Function(ProfileDocsResponseDto) _then) =
      _$ProfileDocsResponseDtoCopyWithImpl;
  @useResult
  $Res call({String id, String name, int age, String gender});
}
...
extension ProfileDocsResponseDtoPatterns on ProfileDocsResponseDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ProfileDocsResponseDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, int age, String gender)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, String name, int age, String gender) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _ProfileDocsResponseDto():
...
class _ProfileDocsResponseDto implements ProfileDocsResponseDto {
  const _ProfileDocsResponseDto(
      {required this.id,
      required this.name,
      required this.age,
      required this.gender});
  factory _ProfileDocsResponseDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProfileDocsResponseDtoCopyWith<_ProfileDocsResponseDto> get copyWith =>
      __$ProfileDocsResponseDtoCopyWithImpl<_ProfileDocsResponseDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ProfileDocsResponseDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProfileDocsResponseDto &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.age, age) || other.age == age) &&
            (identical(other.gender, gender) || other.gender == gender));
...
/// @nodoc
abstract mixin class _$ProfileDocsResponseDtoCopyWith<$Res>
    implements $ProfileDocsResponseDtoCopyWith<$Res> {
  factory _$ProfileDocsResponseDtoCopyWith(_ProfileDocsResponseDto value,
          $Res Function(_ProfileDocsResponseDto) _then) =
      __$ProfileDocsResponseDtoCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String name, int age, String gender});
}
